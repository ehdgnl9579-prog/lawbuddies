...
const CONFIG = {
  categories: [
    ...
    { cat: "금융", queries: ["금융위원회", "가상자산 규제", "금융감독원 제재"] },
    { cat: "형사", queries: ["검찰 수사", "형사 판결", "구속영장"] },
    { cat: "노동", queries: ["중앙노동위원회", "통상임금 판결", "중대재해처벌법"] },
    { cat: "M&A", queries: ["공정거래위원회 기업결합", "인수합병 승인"] },
    { cat: "시사", queries: ["국회 본회의", "주요 경제지표"] },
  ],
  perQuery:  10,   // 쿼리당 요청 건수
  sort:      "date",
  freshDays: 2,    // 최근 N일 이내만 유지
  maxPerCat: 6,    // 카테고리별 최종 노출 상한
  gapMs:     150,  // 요청 사이 간격
};
